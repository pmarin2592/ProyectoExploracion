...
class PcaEda:
    ...
    def graficar_3d_con_planos(self):
        return self.pca_datos.graficar_3d_con_planos()

    def graficar_proyeccion_pc1_pc2(self):
        return self.pca_datos.graficar_proyeccion_pc1_pc2()

    def graficar_proyeccion_pc1_pc3(self):
        return self.pca_datos.graficar_proyeccion_pc1_pc3()

    def graficar_heatmap_loadings(self):
        return self.pca_datos.graficar_heatmap_loadings()

    def graficar_circulo_correlacion(self):
        return self.pca_datos.graficar_circulo_correlacion()

    def graficar_contribuciones_variables(self):
        return self.pca_datos.graficar_contribuciones_variables()

    def graficar_analisis_cuadrantes(self):
        return self.pca_datos.graficar_analisis_cuadrantes()
